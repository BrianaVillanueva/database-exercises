...
SELECT CONCAT(first_name, ' ', last_name) AS Name FROM employees WHERE last_name LIKE '%e%';
...
SELECT DATEDIFF(hire_date, CURDATE()) AS 'days since hire' FROM employees WHERE birth_date LIKE '%12-25' AND hire_date LIKE '199%';
