...
# Irene Isaak
# Dulce Wrigley
SELECT * FROM employees WHERE birth_date LIKE '%12-25' AND hire_date LIKE '199%' ORDER BY birth_date ASC, hire_date DESC LIMIT 5;
...
# Basil Senzako
# Mabo Zobel
SELECT * FROM employees WHERE birth_date LIKE '%12-25' AND hire_date LIKE '199%' ORDER BY birth_date ASC, hire_date DESC LIMIT 5 OFFSET 45; #offset 50 would give the 11th page
